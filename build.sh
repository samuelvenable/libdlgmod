...
if [ `uname -o` = "Msys" ]; then
  ...
  ar rc "libdlgmod.a" "libdlgmod/win32/libdlgmod.o" "libdlgmod/general/apiprocess/process.o" "libdlgmod/general/xprocess.o";
  ...
  ar rc "libdlgmod.a" "libdlgmod/macos/libdlgmod.o";
  ...
  ar rc "libdlgmod.a" "libdlgmod/xlib/libdlgmod.o" "libdlgmod/general/apiprocess/process.o" "libdlgmod/general/xprocess.o" "libdlgmod/general/lodepng.o";
